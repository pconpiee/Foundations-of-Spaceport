  ...
  const QUIZ = [
    {
      ...
      options: [
        ...
        { id: 'b', text: 'Upstream is the government sector; downstream is the commercial sector.' },
        { id: 'c', text: 'Upstream encompasses launch and satellite manufacturing (getting to space); downstream encompasses satellite services, data analytics, and applications (value derived from space).' },
    ...
    },
    {
      ...
      options: [
        ...
        { id: 'b', text: 'Revenue from licensing the spaceport\'s operational procedures to other spaceports.' },
        { id: 'c', text: 'Government grants and state economic development subsidies.' },
        { id: 'd', text: 'Tenant fees from aerospace companies, system integrators, and technology firms co-locating at the spaceport.' },
      ],
      correct: 'd',
    ...
    },
    {
      ...
      options: [
        { id: 'a', text: 'Launch-fee revenue alone is rarely sufficient to service $200 million in capital investment — the investment case must include the full economic impact (jobs, induced economic activity, tenant revenues, and regional development) which is broader than direct facility revenue.' },
        { id: 'b', text: 'The state should only invest in spaceports that are already operating, not greenfield developments.' },
    ...
    },
    {
      ...
      options: [
        { id: 'a', text: 'EBITDA margin (earnings before interest, taxes, depreciation, and amortization, as a percentage of revenue).' },
        { id: 'b', text: 'Net profit margin (net income as a percentage of total revenue).' },
        { id: 'c', text: 'Total annual launch revenue.' },
    ...
    },
    {
      ...
      options: [
        ...
        { id: 'b', text: 'Export control compliance costs for regulated payload components.' },
        { id: 'c', text: 'Insurance premiums required by the launch operator before they will accept the payload.' },
        { id: 'd', text: 'Mission integration and interface costs — the engineering work required to integrate a payload with a specific launch vehicle.' },
      ],
      correct: 'd',
    ...
    },
    {
      ...
      options: [
        ...
        { id: 'b', text: 'Driver: launch cost reductions driving new applications. Risk: whether SpaceX maintains its cost leadership.' },
        { id: 'c', text: 'Driver: commercial satellite services expansion (broadband, Earth observation, navigation). Risk: whether customer demand for space-based services materializes at projected scale.' },
...
<div class="segment-content">
  ...
  <div class="seg-body">
    ...
    <p>This module maps the commercial space economy as the market context within which spaceports operate, then builds the financial architecture of the spaceport business: revenue models, cost structures, capital investment, and the financial metrics that executives use to evaluate operational performance. The case study returns to Spaceport America — introduced in Module 1 as a site selection and financing case — and examines it through a financial modeling lens: specifically, how a $220 million public investment produced a revenue gap problem that the facility's original financial model did not anticipate, and what the structural corrections look like.</p>
    <div class="callout callout-insight">
...
<div class="segment-content">
  ...
  <div class="seg-body">
    ...
    <p>Spaceport America, located in the New Mexico desert approximately 45 miles north of Las Cruces, is the world's first purpose-built commercial spaceport. Designed by architectural firm Foster + Partners, it features a 12,000-foot runway and Gateway to Space terminal, a launch complex for vertical launch operations, and supporting infrastructure built to serve multiple commercial operators.</p>
